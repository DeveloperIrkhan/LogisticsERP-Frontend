            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-10 px-4 py-7 rounded-t-2xl bg-linear-to-r from-red-400 to-red-900">
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-5">
                        <div>
                            <h1 className="text-3xl text-white font-extrabold">Item Sales</h1>
                        ...
                        <div className="flex items-center gap-4">
                            <div className="bg-white/20 shadow-lg border border-white/20 rounded-2xl px-6 py-4">
                                ...
                                <h2 className="text-3xl font-bold text-white">{sales.length}</h2>
                            </div>
                            <div className="bg-white/20 shadow-lg border border-white/20 rounded-2xl px-6 py-4">
                            ...
                            >
                                ...
                                <div className="relative p-6">
                                    ...
                                    <div className="mt-6 flex justify-between items-center">
                                        <Link
                                            href={`/item-sale/get-by-id/${s.itemSaleId}`}
