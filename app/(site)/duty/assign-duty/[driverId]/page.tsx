...
import { DutyType, IDutyCreateDto } from "@/modules/duty/dutyTypes";
import { createDutyAsync } from "@/modules/duty/api";
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <CustomInput
                                    ...
                                    value={driverId as string}
                                    disabled={true}
                                    onChange={(value) => handleChange("driverId", value)}
                                />
