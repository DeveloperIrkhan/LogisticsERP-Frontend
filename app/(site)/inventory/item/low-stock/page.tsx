...
import { getLowStockItemsAsync } from "@/modules/inventory/items/api";
import ItemCard from "@/modules/inventory/items/ItemCard";
...
const page = () => {
    ...
    useEffect(() => {
        const fetchItems = async () => {
            try {
                setIsLoading(true);
                const response = await getLowStockItemsAsync();
                if (response.success) {
