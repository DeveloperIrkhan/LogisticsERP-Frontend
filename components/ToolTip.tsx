...
import { SOCIAL_LINKS, type SocialLink } from '../app/constants/constants';
import { FacebookIcon, TwitterIcon, LinkedinIcon, YoutubeIcon } from '../app/constants/SocialIcons';
...
export default function TopBar() {
    return (
        <div className="hidden bg-black/90 text-gray-300 md:block">
