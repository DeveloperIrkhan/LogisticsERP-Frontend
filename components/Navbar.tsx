...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 font-raleway transition-all duration-300`}
    >
      {/* TOP BAR */}
      <div
        className={`flex items-center justify-between px-6 md:px-12 py-4 text-white transition-all duration-300 ${
